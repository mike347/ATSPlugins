...
{ 
	...
	{ 
		name = "ChatGrabberMain", version = 2.23, page = "http://zen.trekmush.org/ats/beta/",
		filename = "ATS_Chatgrabber.xml", infopage = "http://zen.trekmush.org/chatgrabber/",
        whatsnew = "(2.23) Reduced max stored lines to curtail crashing on some systems.",
	}, 
	["981f20859e43e90c624fa1ff"] = 
	{
		name = "ChatGrabberSlave1", version = 2.23, page = "http://zen.trekmush.org/ats/beta/",
		filename = "ATS_ChatgrabberSlave1.xml",  infopage = "http://zen.trekmush.org/chatgrabber/",
	},
	["d183a293b696885487d3ad83"] =
	{
		name = "ChatGrabberSlave2", version = 2.23, page = "http://zen.trekmush.org/ats/beta/", 
