-- ATS MC Plugins Version info
version_info = 
{ 
	["de6b99ef3f79191fd27d59b0"] = 
	{ 
		name = "ChatGrabberMain", version = 2.20, page = "http://qon.pennmush.org/ats/beta/",
		filename = "ATS_Chatgrabber.xml", infopage = "http://qon.pennmush.org/chatgrabber/",
        whatsnew = "(v2.20) Hyperlinks display properly in the main window.\n* AutoURL Shortener option -- When enabled, any URL you type in the command window (and hit enter) will be tinyurl.com'd automagically.",
	}, 
	["981f20859e43e90c624fa1ff"] = 
	{
		name = "ChatGrabberSlave1", version = 2.20, page = "http://qon.pennmush.org/ats/beta/",
		filename = "ATS_ChatgrabberSlave1.xml",  infopage = "http://qon.pennmush.org/chatgrabber/",
	},
	["d183a293b696885487d3ad83"] =
	{
		name = "ChatGrabberSlave2", version = 2.20, page = "http://qon.pennmush.org/ats/beta/", 
		filename = "ATS_ChatgrabberSlave2.xml", infopage = "http://qon.pennmush.org/chatgrabber/",
		
	},
	["8e3fd4f9c269365839520477"] = 
	{
		name = "ATS_Navcomp", version = 1.41, page = "http://qon.pennmush.org/ats/beta/",
		filename = "ATS_Navcomp.xml",  infopage = "http://qon.pennmush.org/ats-navcomp/",
        whatsnew = "(v1.4) AutoTuning calculator (type 'sheet', then @listspecs a class)\nNew JSON Datafile (faster loading)\n ncinfo command. (try 'ncinfo fed') More to come. ",
	},
	["1ec11b537d60054d832b896a"] = 
	{
		name = "QUpdater", version = 0.6, page = "http://qon.pennmush.org/ats/beta/", 
		filename = "QUpdater.xml", infopage = "http://qon.pennmush.org/qupdater/",
	},
	["57a49cca2ef1da0b52498a94"] =
	{
		name = "ShieldStatus", version = 1.02, page = "http://qon.pennmush.org/ats/beta/",
		filename = "ATS_ShieldStatus.xml", 
	},
	["14f4885e803e076273a4767a"] = 
	{
		name = "Paste_As_MUSH", version = 1.22, page = "http://qon.pennmush.org/ats/beta/",
		filename = "Paste_As_MUSH.xml", infopage = nil,
	},
	["NavcompData"] = 
	{
		name = "NavComp Database", version = 2.01, page = "http://qon.pennmush.org/ats/beta/",
		filename = "atsdata.json",  infopage = "http://qon.pennmush.org/ats-navcomp/",
	},
    ["f92c816b178f0707847fcd1d"] =
    {
        name = "WeaponBar 2.0 ALPHA", version = 2.06, page = "http://qon.pennmush.org/ats/beta/",
...
ats_navcomp_info = {
	...
	release_url = "http://qon.pennmush.org/mediawiki/index.php/ATS_Nav_Comp_Plugin",
	description = [==[ 
